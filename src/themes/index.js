...
export const themes = {
  ...
  green: {
    ...
    button: {
      variants: {
        default: 'bg-[#ffffff] text-[#1a4a2e] hover:bg-[#f8f9fa]',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-[#ffffff] bg-[#1a4a2e] text-[#ffffff] hover:bg-[#2d5a3d]',
        secondary: 'bg-[#2d5a3d] text-[#ffffff] hover:bg-[#2d5a3d]/80',
        ghost: 'hover:bg-[#2d5a3d] hover:text-[#ffffff]',
        link: 'text-[#ffffff] underline-offset-4 hover:underline',
        // 保留原有的自定义样式
        primary:
          'bg-gradient-to-b from-[#ffffff] via-[#f8f9fa] to-[#e9ecef] text-[#1a4a2e]',
      },
    },
    card: {
      base: 'rounded-lg border border-[#ffffff] bg-[#1a4a2e] text-[#ffffff] shadow-sm',
      header: 'flex flex-col space-y-1.5 p-6',
      title:
